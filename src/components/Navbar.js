...
export default function Navbar() {
 ...
 <div className="flex items-center">
          ...
          <a href="/" className="flex items-center">
            <img src="https://i.ibb.co/b13dvds/PINK-LOGO-GIF.gif" alt="WOOF Logo" className="h-12" />
          </a>
          <h2 className="font-courier-bold text-2xl mr-3">$DIELA</h2>
        </div>
        <div className="flex items-center">
          {/* Social Icons */}
          <a href="https://twitter.com/lucifersoltoken" target="_blank" rel="noopener noreferrer" className="text-pink-600 px-3">
          <svg className="fill-current text-pink hover:text-white" width="30" height="30" viewBox="0 0 1200 1200" xmlns="http://www.w3.org/2000/svg">
              {/* Replace with your Twitter path */}
              <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" />
            </svg>
          </a>
          <a href="https://t.me/dielatoken" target="_blank" rel="noopener noreferrer" className="text-pink-600 px-3">
          <svg className="fill-current text-pink hover:text-white" width="30" height="30" viewBox="0 0 25 19" xmlns="http://www.w3.org/2000/svg">
